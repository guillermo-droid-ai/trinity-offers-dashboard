...
export default function CallsByDay({ leads, dateRange }) {
  // Filter leads that have been called
  ...
  return (
    <div className="glass p-6">
      <h3 className="text-sm font-semibold text-text-secondary mb-4">Calls per Day</h3>
      <div className="h-64">
